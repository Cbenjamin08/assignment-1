    ...
    public static void main(String[] args) throws Exception {
        ...
        loop: while (a == 0) {
            ...
            if (a != 0) {
                ...
                System.out.println("An a value of 0 means that this function is not a cubic, try again");
            }
        }
        ...
        if (discriminant > 0) {
            ...
            System.out.println("There is 3 distinct real roots at the x values of: ");
            System.out.println(root1 + ", " + root2 + ", " + root3);
        } else if (discriminant == 0) {
            if (b * b == 3 * a * c) {
                System.out.println("There is a real triple root at " + -(b / (3 * a)));
            } else {
                root1 = (9 * a * d - b * c) / (2 * (b * b - 3 * a * c));
                root2 = (4 * a * b * c - 9 * a * a * d - b * b * b) / (a * (b * b - 3 * a * c));
                System.out.println(
                        "There is a real repeated root at " + root1 + ", and a distinct real root at " + root2);
            }
        } else {
            ...
            System.out.println("There is a real root: " + root1);
